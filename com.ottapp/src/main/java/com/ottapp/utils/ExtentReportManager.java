...
public class ExtentReportManager {
    ...
    private static ThreadLocal<ExtentTest> testThreadLocal = new ThreadLocal<>(); //used to ensure thread safety when working with ExtentTest instances in a multi-threaded environment, such as when running parallel tests.
